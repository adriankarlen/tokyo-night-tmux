...
# Highlight colors
tmux set -g mode-style "fg=${THEME[bred]},bg=${THEME[bblack]}"
...
#+--- Bars LEFT ---+
# Session name
tmux set -g status-left "#[fg=${THEME[bblack]},bg=${THEME[green]},bold] #{?client_prefix,󰠠 ,#[dim]󰤂 }#[bold,nodim]#S$hostname "
